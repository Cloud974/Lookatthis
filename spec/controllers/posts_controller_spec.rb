  ...
  context "signed-in user" do
    ...
    describe "POST create" do
      it "increases the number of Post by 1" do
        expect{ post :create, params: { topic_id: my_topic, post: { title: RandomData.random_sentence, body: RandomData.random_paragraph } } }.to change(Post,:count).by(1)
      end

      it "assigns the new post to @post" do
        post :create, params: { topic_id: my_topic, post: { title: RandomData.random_sentence, body: RandomData.random_paragraph } }
    ...
    describe "PUT update" do
      it "updates post with expected attributes" do
        ...
        put :update, params: { topic_id: my_topic, id: my_post.id, post: {title: new_title, body: new_body } }
