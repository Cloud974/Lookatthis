...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "GET index" do
    ...
    it "assigns [my_question] to @question" do
      get :index
      expect(assigns(:posts)).to eq ([my_question])
    end
  end
  ...
  describe "POST create" do
    it "increases the number of Question by 1" do
      expect{ post :create, params: { post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: false} } }.to change(Question,:count).by(1)
    end

    it "assigns the new question to @question" do
      post :create, params: { post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: false} }
      expect(assigns(:question)).to eq Question.last
    end

    it "redirects to the new question" do
      post :create, params: { post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: false} }
      exoect(response).to redirect_to Question.last
    end
  end
  ...
  describe "GET #edit" do
    ...
    it "assigns questions to be updated in @question" do
