...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "GET show" do
    it "returns http success" do
      get :show, params: { topic_id: my_topic, id: my_sponsored_post.id}
  ...
  describe "GET new" do
    it "returns http success" do
      get :new, params: { topic_id: my_topic, id: my_sponsored_post.id}
      expect(response).to have_http_status(:success)
    end
  ...
  describe "POST create" do
    it "increases the number of sponsored_post by 1" do
      expect{ post :create, params: { topic_id: my_topic, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph } } }.to change(SponsoredPost,:count).by(1)
    end

    it "assigns the new sponsored_post to @sponsored_post" do
      post :create, params: { topic_id: my_topic, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph } }
  ...
  describe "GET edit" do
    it "returns http success" do
      get :edit, params: { topic_id: my_topic, id: my_sponsored_post.id }
      expect(response).to have_http_status(:success)
    end
    ...
    it "assigns sponsored_posts to be updated to @sponsored_post" do
      get :edit, params: { topic_id: my_topic, id: my_sponsored_post.id }
  ...
  describe "PUT update" do
    it "updates sponsored_post with expected attributes" do
      ...
      put :update, params: { topic_id: my_topic, id: my_sponsored_post.id, sponsored_post: {title: new_title, body: new_body } }
  ...
  describe "DELETE destroy" do
    it "deletes the sponsored_post" do
      delete :destroy, params: { topic_id: my_topic, id: my_sponsored_post.id }
