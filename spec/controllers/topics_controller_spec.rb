...
RSpec.describe TopicsController, type: :controller do
  ...
  context "member user" do
    before do
      user = User.create!(name: "lookit User", email: "user@lookit.com", password: "helloworld", role: :member)
      create_session(user)
    end
  ...
  context "admin user" do
    before do
      user = User.create!(name: "lookit User", email: "user@lookit.com", password: "helloworld", role: :admin)
      create_session(user)
    end
